...
const aboutPageContent = {
  en: {
    ...
    building: {
      ...
      intro: "I'm particularly interested in interfaces that feel structured, intuitive, and close to real products, not just static demos.",
      cards: [
        {
      ...
      note: "Most of my projects follow a Single Page Application approach, with emphasis on clean state management, reusable components, and clear data flow."
    },
    work: {
      eyebrow: "Process",
      title: "How I work",
      intro: "I approach frontend development as part of a complete system, not just the visual layer.",
      points: [
      ...
      closing: "My engineering background and presales experience help me bridge business needs with technical implementation. I tend to think in systems rather than isolated features."
    },
    focus: {
  ...
  gr: {
    ...
    building: {
      ...
      intro: "Με ενδιαφέρουν interfaces που είναι δομημένα, κατανοητά και κοντά σε πραγματικά προϊόντα, όχι απλώς demo εφαρμογές.",
      cards: [
        {
          title: "Responsive interfaces",
      ...
      note: "Τα περισσότερα projects μου ακολουθούν λογική Single Page Application, με έμφαση σε καθαρό state management, επαναχρησιμοποιήσιμα components και ξεκάθαρο data flow."
    },
    work: {
      eyebrow: "Process",
      title: "Πώς δουλεύω",
      intro: "Βλέπω το frontend development ως μέρος ενός μεγαλύτερου συστήματος, όχι απλώς ως το οπτικό κομμάτι μιας εφαρμογής.",
      points: [
      ...
      closing: "Το υπόβαθρο στη μηχανική και η εμπειρία μου στο presales με βοηθούν να γεφυρώνω τις ανάγκες του χρήστη και της επιχείρησης με την τεχνική υλοποίηση. Προσπαθώ να σκέφτομαι σε επίπεδο συστημάτων και όχι μόνο μεμονωμένων features."
    },
    focus: {
      eyebrow: "Current focus",
      title: "Τρέχον focus",
...
export { aboutContent as a, aboutPageContent as b };
